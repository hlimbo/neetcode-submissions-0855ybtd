...
class Solution:
    def backtrackFromTreasure(self, grid: List[List[int]], treasureLocation: (int, int)) -> None:
        bfsQueue = Queue()
        visited = set()
        
        bfsQueue.put(treasureLocation)
    ...
    def islandsAndTreasure(self, grid: List[List[int]]) -> None:
        ...
        for treasureLocation in treasureLocations:
            self.backtrackFromTreasure(grid, treasureLocation)
